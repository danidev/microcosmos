...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = (0.00499999989f / fConst0);
		float fConst4 = std::tan((3769.91113f / fConst0));
		float fConst5 = (1.0f / fConst4);
		fConst6 = (1.0f / (((fConst5 + 0.5f) / fConst4) + 1.0f));
		fConst7 = std::max<float>(1.0f, (0.00999999978f * fConst0));
		fConst8 = (1.0f / fConst7);
		fConst9 = (1.0f / std::max<float>(1.0f, (0.109999999f * fConst0)));
		fConst10 = (((fConst5 + -0.5f) / fConst4) + 1.0f);
		fConst11 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fConst4))));
		fConst12 = (1.0f / std::max<float>(1.0f, (0.0500000007f * fConst0)));
		float fConst13 = std::tan((9424.77832f / fConst0));
		float fConst14 = (1.0f / fConst13);
		fConst15 = (1.0f / (((fConst14 + 0.25f) / fConst13) + 1.0f));
		fConst16 = (((fConst14 + -0.25f) / fConst13) + 1.0f);
		fConst17 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fConst13))));
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(30.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addButton("hat_trigger", &fButton2);
		ui_interface->addHorizontalSlider("kick_pitch", &fHslider0, FAUSTFLOAT(30.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addButton("kick_trigger", &fButton0);
		ui_interface->addButton("snare_trigger", &fButton1);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = ((101.199997f * fSlow0) + (0.00139999995f * std::pow((440.0f * fSlow0), 1.5f)));
		...
		float fSlow7 = float(fButton2);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			fVec0[0] = fSlow3;
			iRec1[0] = (((fSlow3 > fVec0[1]) ? 0 : iRec1[1]) + 1);
			float fTemp0 = float(iRec1[0]);
			fRec0[0] = ((0.99000001f * fRec0[1]) + (0.00999999978f * std::exp((0.0f - (fSlow2 * fTemp0)))));
			float fTemp1 = (fRec3[1] + (fSlow4 * ((fSlow5 * fTemp0) + 1.0f)));
			fRec3[0] = (fTemp1 - std::floor(fTemp1));
			iRec5[0] = ((1103515245 * iRec5[1]) + 12345);
			float fTemp2 = float(iRec5[0]);
			fVec2[0] = fSlow6;
			iRec6[0] = (((iRec6[1] + (iRec6[1] > 0)) * (fSlow6 <= fVec2[1])) + (fSlow6 > fVec2[1]));
			float fTemp3 = float(iRec6[0]);
			fRec4[0] = ((4.65661287e-10f * (fTemp2 * std::max<float>(0.0f, std::min<float>((fConst8 * fTemp3), ((fConst9 * (fConst7 - fTemp3)) + 1.0f))))) - (fConst6 * ((fConst10 * fRec4[2]) + (fConst11 * fRec4[1]))));
			fVec3[0] = fSlow7;
			iRec7[0] = (((iRec7[1] + (iRec7[1] > 0)) * (fSlow7 <= fVec3[1])) + (fSlow7 > fVec3[1]));
			float fTemp4 = float(iRec7[0]);
			float fTemp5 = (fTemp2 * std::max<float>(0.0f, std::min<float>((fConst8 * fTemp4), ((fConst12 * (fConst7 - fTemp4)) + 1.0f))));
			fRec8[0] = ((4.65661287e-10f * fTemp5) - (fConst15 * ((fConst16 * fRec8[2]) + (fConst17 * fRec8[1]))));
			float fTemp6 = ((((fRec0[0] * ftbl0mydspSIG0[int((65536.0f * fRec3[0]))]) + (fConst6 * (((0.949999988f * fRec4[0]) + (1.89999998f * fRec4[1])) + (0.949999988f * fRec4[2])))) + (3.49245965e-10f * fTemp5)) - (fConst15 * (((0.75f * fRec8[0]) + (1.5f * fRec8[1])) + (0.75f * fRec8[2]))));
	...
	FAUST_ADDBUTTON("hat_trigger", fButton2);
	FAUST_ADDHORIZONTALSLIDER("kick_pitch", fHslider0, 30.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDBUTTON("kick_trigger", fButton0);
	FAUST_ADDBUTTON("snare_trigger", fButton1);

	#define FAUST_LIST_ACTIVES(p) \
		p(BUTTON, hat_trigger, "hat_trigger", fButton2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, kick_pitch, "kick_pitch", fHslider0, 30.0f, 0.0f, 127.0f, 1.0f) \
		p(BUTTON, kick_trigger, "kick_trigger", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, snare_trigger, "snare_trigger", fButton1, 0.0f, 0.0f, 1.0f, 1.0f) \

...
Compilation options: -a /usr/local/share/faust/teensy/teensy.cpp -lang cpp -es 1 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /usr/local/share/faust/teensy/teensy.cpp -lang cpp -es 1 -single -ftz 0");
		...
		m->declare("filename", "MicrocosmosDsp.dsp");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("MicrocosmosDsp");
		ui_interface->addHorizontalSlider("1a", &fHslider0, FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(4.5f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("2d", &fHslider2, FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(4.5f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("3s", &fHslider1, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("4r", &fHslider3, FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(4.5f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("cutoff", &fHslider15, FAUSTFLOAT(5000.0f), FAUSTFLOAT(50.0f), FAUSTFLOAT(10000.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("cutoff_env", &fHslider17, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("cutoff_lfo", &fHslider16, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("duty", &fHslider10, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("duty_env", &fHslider12, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("duty_lfo", &fHslider11, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addButton("gate", &fButton0);
		ui_interface->addHorizontalSlider("lfo_1_freq", &fHslider7, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(8.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("noise", &fHslider14, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("note", &fHslider5, FAUSTFLOAT(64.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("pitch_env", &fHslider8, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("pitch_lfo", &fHslider6, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("resonance", &fHslider18, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(15.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("vol_a", &fHslider9, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("vol_b", &fHslider4, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("vol_c", &fHslider13, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow7 = std::pow(2.0f, (0.0833333358f * (float(fHslider5) + -69.0f)));
		float fSlow8 = (440.0f * fSlow7);
		float fSlow9 = (fConst1 * float(fHslider6));
		float fSlow10 = (fConst1 * float(fHslider7));
		float fSlow11 = (fConst1 * float(fHslider8));
		float fSlow12 = (fConst1 * float(fHslider9));
		float fSlow13 = (fConst1 * float(fHslider10));
		float fSlow14 = (fConst1 * float(fHslider11));
		float fSlow15 = (fConst1 * float(fHslider12));
		float fSlow16 = (fConst1 * float(fHslider13));
		float fSlow17 = (220.0f * fSlow7);
		float fSlow18 = (fConst1 * float(fHslider14));
		float fSlow19 = (fConst1 * float(fHslider15));
		float fSlow20 = (fConst1 * float(fHslider16));
		float fSlow21 = (fConst1 * float(fHslider17));
		float fSlow22 = (fConst1 * float(fHslider18));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp1 = std::max<float>(0.0f, (std::min<float>((fRec0[0] / fTemp0), std::max<float>(((((1.0f - fRec2[0]) * (fTemp0 - fRec0[0])) / std::max<float>(1.0f, (fConst0 * fRec3[0]))) + 1.0f), fRec2[0])) * (1.0f - (float(iRec4[0]) / std::max<float>(1.0f, (fConst0 * fRec5[0]))))));
			fRec7[0] = (fSlow6 + (fConst2 * fRec7[1]));
			fRec10[0] = (fSlow9 + (fConst2 * fRec10[1]));
			fRec12[0] = (fSlow10 + (fConst2 * fRec12[1]));
			float fTemp2 = (fRec11[1] + (fConst3 * fRec12[0]));
			fRec11[0] = (fTemp2 - std::floor(fTemp2));
			float fTemp3 = ((2.0f * (1.0f - std::fabs(((2.0f * fRec11[0]) + -1.0f)))) + -1.0f);
			fRec13[0] = (fSlow11 + (fConst2 * fRec13[1]));
			float fTemp4 = (((fRec10[0] * fTemp3) + 1.0f) + (fRec13[0] * fTemp1));
			float fTemp5 = (fSlow8 * fTemp4);
			float fTemp6 = std::max<float>(1.1920929e-07f, std::fabs(fTemp5));
			...
			fRec14[0] = (fSlow12 + (fConst2 * fRec14[1]));
			float fTemp10 = float(iVec1[1]);
			float fTemp11 = std::max<float>(fTemp5, 23.4489498f);
			float fTemp12 = std::max<float>(20.0f, std::fabs(fTemp11));
			float fTemp13 = (fRec15[1] + (fConst3 * fTemp12));
			fRec15[0] = (fTemp13 - std::floor(fTemp13));
			float fTemp14 = mydsp_faustpower2_f(((2.0f * fRec15[0]) + -1.0f));
			fVec2[0] = fTemp14;
			float fTemp15 = ((fTemp10 * (fTemp14 - fVec2[1])) / fTemp12);
			fVec3[(IOTA & 4095)] = fTemp15;
			fRec16[0] = (fSlow13 + (fConst2 * fRec16[1]));
			fRec17[0] = (fSlow14 + (fConst2 * fRec17[1]));
			fRec18[0] = (fSlow15 + (fConst2 * fRec18[1]));
			float fTemp16 = std::max<float>(0.0f, std::min<float>(2047.0f, (fConst0 * ((fRec16[0] * (((fRec17[0] * fTemp3) + 1.0f) + (fRec18[0] * fTemp1))) / fTemp11))));
			int iTemp17 = int(fTemp16);
			float fTemp18 = std::floor(fTemp16);
			fRec19[0] = (fSlow16 + (fConst2 * fRec19[1]));
			float fTemp19 = std::max<float>((fSlow17 * fTemp4), 23.4489498f);
			float fTemp20 = std::max<float>(20.0f, std::fabs(fTemp19));
			float fTemp21 = (fRec20[1] + (fConst3 * fTemp20));
			fRec20[0] = (fTemp21 - std::floor(fTemp21));
			float fTemp22 = mydsp_faustpower2_f(((2.0f * fRec20[0]) + -1.0f));
			fVec4[0] = fTemp22;
			float fTemp23 = ((fTemp10 * (fTemp22 - fVec4[1])) / fTemp20);
			fVec5[(IOTA & 4095)] = fTemp23;
			float fTemp24 = std::max<float>(0.0f, std::min<float>(2047.0f, (fConst5 / fTemp19)));
			int iTemp25 = int(fTemp24);
			float fTemp26 = std::floor(fTemp24);
			fRec21[0] = (fSlow18 + (fConst2 * fRec21[1]));
			iRec22[0] = ((1103515245 * iRec22[1]) + 12345);
			fRec23[0] = (fSlow19 + (fConst2 * fRec23[1]));
			fRec24[0] = (fSlow20 + (fConst2 * fRec24[1]));
			fRec25[0] = (fSlow21 + (fConst2 * fRec25[1]));
			float fTemp27 = std::tan((fConst6 * (fRec23[0] * (((fRec24[0] * fTemp3) + 1.0f) + (fRec25[0] * fTemp1)))));
			float fTemp28 = (1.0f / fTemp27);
			fRec26[0] = (fSlow22 + (fConst2 * fRec26[1]));
			float fTemp29 = (1.0f / fRec26[0]);
			float fTemp30 = (((fTemp29 + fTemp28) / fTemp27) + 1.0f);
			fRec6[0] = ((((fRec7[0] * ((2.0f * fRec9) + -1.0f)) + (fConst4 * ((fRec14[0] * ((fTemp15 - (fVec3[((IOTA - iTemp17) & 4095)] * (fTemp18 + (1.0f - fTemp16)))) - ((fTemp16 - fTemp18) * fVec3[((IOTA - (iTemp17 + 1)) & 4095)]))) + (fRec19[0] * ((fTemp23 - (fVec5[((IOTA - iTemp25) & 4095)] * (fTemp26 + (1.0f - fTemp24)))) - ((fTemp24 - fTemp26) * fVec5[((IOTA - (iTemp25 + 1)) & 4095)])))))) + (4.65661287e-10f * (fRec21[0] * float(iRec22[0])))) - (((fRec6[2] * (((fTemp28 - fTemp29) / fTemp27) + 1.0f)) + (2.0f * (fRec6[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp27)))))) / fTemp30));
			float fTemp31 = ((fTemp1 * (((0.899999976f * fRec6[0]) + (1.79999995f * fRec6[1])) + (0.899999976f * fRec6[2]))) / fTemp30);
	...
	#define FAUST_FILE_NAME "MicrocosmosDsp.dsp"
	#define FAUST_CLASS_NAME "mydsp"
	#define FAUST_INPUTS 0
	#define FAUST_OUTPUTS 2
	#define FAUST_ACTIVES 20
	#define FAUST_PASSIVES 0

	FAUST_ADDHORIZONTALSLIDER("1a", fHslider0, 0.01f, 0.01f, 4.5f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("2d", fHslider2, 0.01f, 0.01f, 4.5f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("3s", fHslider1, 1.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("4r", fHslider3, 0.01f, 0.01f, 4.5f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("cutoff", fHslider15, 5000.0f, 50.0f, 10000.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("cutoff_env", fHslider17, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("cutoff_lfo", fHslider16, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("duty", fHslider10, 0.5f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("duty_env", fHslider12, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("duty_lfo", fHslider11, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDBUTTON("gate", fButton0);
	FAUST_ADDHORIZONTALSLIDER("lfo_1_freq", fHslider7, 1.0f, 0.01f, 8.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("noise", fHslider14, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("note", fHslider5, 64.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("pitch_env", fHslider8, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("pitch_lfo", fHslider6, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("resonance", fHslider18, 1.0f, 1.0f, 15.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("vol_a", fHslider9, 0.5f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("vol_b", fHslider4, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("vol_c", fHslider13, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, 1a, "1a", fHslider0, 0.01f, 0.01f, 4.5f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, 2d, "2d", fHslider2, 0.01f, 0.01f, 4.5f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, 3s, "3s", fHslider1, 1.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, 4r, "4r", fHslider3, 0.01f, 0.01f, 4.5f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, cutoff, "cutoff", fHslider15, 5000.0f, 50.0f, 10000.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, cutoff_env, "cutoff_env", fHslider17, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, cutoff_lfo, "cutoff_lfo", fHslider16, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, duty, "duty", fHslider10, 0.5f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, duty_env, "duty_env", fHslider12, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, duty_lfo, "duty_lfo", fHslider11, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(BUTTON, gate, "gate", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, lfo_1_freq, "lfo_1_freq", fHslider7, 1.0f, 0.01f, 8.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, noise, "noise", fHslider14, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, note, "note", fHslider5, 64.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, pitch_env, "pitch_env", fHslider8, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, pitch_lfo, "pitch_lfo", fHslider6, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, resonance, "resonance", fHslider18, 1.0f, 1.0f, 15.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, vol_a, "vol_a", fHslider9, 0.5f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, vol_b, "vol_b", fHslider4, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, vol_c, "vol_c", fHslider13, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
...
MicrocosmosDsp::MicrocosmosDsp() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void MicrocosmosDsp::updateImp(void)
{
#if MIDICTRL
...
void MicrocosmosDsp::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void MicrocosmosDsp::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float MicrocosmosDsp::getParamValue(const std::string& path)
{

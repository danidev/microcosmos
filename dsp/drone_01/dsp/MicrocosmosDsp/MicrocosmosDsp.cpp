...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("AMOUNT", &fHslider12, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("FEEDBACK", &fHslider13, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("TIME", &fHslider14, FAUSTFLOAT(250.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1000.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalBargraph("V1 LED LFO", &fHbargraph0, FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("V1 LFO DEEP", &fHslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("V1 LFO FREQ", &fHslider3, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(80.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("V1 NOTE", &fHslider1, FAUSTFLOAT(69.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("V1 VOLUME", &fHslider0, FAUSTFLOAT(0.100000001f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.899999976f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalBargraph("V2 LED LFO", &fHbargraph1, FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("V2 LFO DEEP", &fHslider6, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("V2 LFO FREQ", &fHslider7, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(80.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("V2 NOTE", &fHslider5, FAUSTFLOAT(69.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("V2 VOLUME", &fHslider4, FAUSTFLOAT(0.100000001f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.899999976f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalBargraph("V3 LED LFO", &fHbargraph2, FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("V3 LFO DEEP", &fHslider10, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("V3 LFO FREQ", &fHslider11, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(80.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("V3 NOTE", &fHslider9, FAUSTFLOAT(69.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("V3 VOLUME", &fHslider8, FAUSTFLOAT(0.100000001f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.899999976f), FAUSTFLOAT(0.100000001f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow8 = (fConst2 * float(fHslider7));
		float fSlow9 = (fConst2 * float(fHslider8));
		float fSlow10 = float(fHslider9);
		float fSlow11 = (fConst2 * float(fHslider10));
		float fSlow12 = (fConst2 * float(fHslider11));
		float fSlow13 = float(fHslider12);
		float fSlow14 = float(fHslider13);
		int iSlow15 = (int((48.0f * float(fHslider14))) + 1);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			iVec0[0] = 1;
			fVec1[0] = fSlow0;
			iRec0[0] = (iRec0[1] != ((fSlow0 - fVec1[1]) == 1.0f));
			fRec1[0] = (fSlow1 + (fConst3 * fRec1[1]));
			float fTemp0 = float(iVec0[1]);
			fRec3[0] = (fSlow3 + (fConst3 * fRec3[1]));
			fRec5[0] = (fSlow4 + (fConst3 * fRec5[1]));
			float fTemp1 = (fRec4[1] + (fConst4 * fRec5[0]));
			fRec4[0] = (fTemp1 - std::floor(fTemp1));
			fHbargraph0 = FAUSTFLOAT((24.0f * ((2.0f * (1.0f - std::fabs(((2.0f * fRec4[0]) + -1.0f)))) + -1.0f)));
			float fTemp2 = std::max<float>((440.0f * std::pow(2.0f, (0.0833333358f * (fSlow2 + ((fRec3[0] * fHbargraph0) + -69.0f))))), 23.4489498f);
			float fTemp3 = std::max<float>(20.0f, std::fabs(fTemp2));
			float fTemp4 = (fRec2[1] + (fConst4 * fTemp3));
			fRec2[0] = (fTemp4 - std::floor(fTemp4));
			float fTemp5 = mydsp_faustpower2_f(((2.0f * fRec2[0]) + -1.0f));
			fVec2[0] = fTemp5;
			float fTemp6 = ((fTemp0 * (fTemp5 - fVec2[1])) / fTemp3);
			fVec3[(IOTA & 4095)] = fTemp6;
			float fTemp7 = std::max<float>(0.0f, std::min<float>(2047.0f, (fConst5 / fTemp2)));
			int iTemp8 = int(fTemp7);
			float fTemp9 = std::floor(fTemp7);
			fRec6[0] = (fSlow5 + (fConst3 * fRec6[1]));
			fRec8[0] = (fSlow7 + (fConst3 * fRec8[1]));
			fRec10[0] = (fSlow8 + (fConst3 * fRec10[1]));
			float fTemp10 = (fRec9[1] + (fConst4 * fRec10[0]));
			fRec9[0] = (fTemp10 - std::floor(fTemp10));
			fHbargraph1 = FAUSTFLOAT((24.0f * ((2.0f * (1.0f - std::fabs(((2.0f * fRec9[0]) + -1.0f)))) + -1.0f)));
			float fTemp11 = std::max<float>((440.0f * std::pow(2.0f, (0.0833333358f * (fSlow6 + ((fRec8[0] * fHbargraph1) + -69.0f))))), 23.4489498f);
			float fTemp12 = std::max<float>(20.0f, std::fabs(fTemp11));
			float fTemp13 = (fRec7[1] + (fConst4 * fTemp12));
			fRec7[0] = (fTemp13 - std::floor(fTemp13));
			float fTemp14 = mydsp_faustpower2_f(((2.0f * fRec7[0]) + -1.0f));
			fVec4[0] = fTemp14;
			float fTemp15 = ((fTemp0 * (fTemp14 - fVec4[1])) / fTemp12);
			...
			fRec13[0] = (fSlow11 + (fConst3 * fRec13[1]));
			fRec15[0] = (fSlow12 + (fConst3 * fRec15[1]));
			float fTemp19 = (fRec14[1] + (fConst4 * fRec15[0]));
			fRec14[0] = (fTemp19 - std::floor(fTemp19));
			fHbargraph2 = FAUSTFLOAT((24.0f * ((2.0f * (1.0f - std::fabs(((2.0f * fRec14[0]) + -1.0f)))) + -1.0f)));
			float fTemp20 = std::max<float>((440.0f * std::pow(2.0f, (0.0833333358f * (fSlow10 + ((fRec13[0] * fHbargraph2) + -69.0f))))), 23.4489498f);
			float fTemp21 = std::max<float>(20.0f, std::fabs(fTemp20));
			float fTemp22 = (fRec12[1] + (fConst4 * fTemp21));
			fRec12[0] = (fTemp22 - std::floor(fTemp22));
			float fTemp23 = mydsp_faustpower2_f(((2.0f * fRec12[0]) + -1.0f));
			fVec6[0] = fTemp23;
			float fTemp24 = ((fTemp0 * (fTemp23 - fVec6[1])) / fTemp21);
			fVec7[(IOTA & 4095)] = fTemp24;
			float fTemp25 = std::max<float>(0.0f, std::min<float>(2047.0f, (fConst5 / fTemp20)));
			int iTemp26 = int(fTemp25);
			float fTemp27 = std::floor(fTemp25);
			float fTemp28 = (fConst1 * (float(iRec0[0]) * (((fRec1[0] * ((fTemp6 - (fVec3[((IOTA - iTemp8) & 4095)] * (fTemp9 + (1.0f - fTemp7)))) - ((fTemp7 - fTemp9) * fVec3[((IOTA - (iTemp8 + 1)) & 4095)]))) + (fRec6[0] * ((fTemp15 - (fVec5[((IOTA - iTemp17) & 4095)] * (fTemp18 + (1.0f - fTemp16)))) - ((fTemp16 - fTemp18) * fVec5[((IOTA - (iTemp17 + 1)) & 4095)])))) + (fRec11[0] * ((fTemp24 - (fVec7[((IOTA - iTemp26) & 4095)] * (fTemp27 + (1.0f - fTemp25)))) - ((fTemp25 - fTemp27) * fVec7[((IOTA - (iTemp26 + 1)) & 4095)]))))));
			fRec16[(IOTA & 65535)] = (fTemp28 + (fSlow14 * fRec16[((IOTA - iSlow15) & 65535)]));
			float fTemp29 = (fTemp28 + (fSlow13 * fRec16[((IOTA - 0) & 65535)]));
	...
	FAUST_ADDHORIZONTALSLIDER("AMOUNT", fHslider12, 0.5f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("FEEDBACK", fHslider13, 0.5f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("TIME", fHslider14, 250.0f, 0.0f, 1000.0f, 1.0f);
	FAUST_ADDHORIZONTALBARGRAPH("V1 LED LFO", fHbargraph0, -1.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("V1 LFO DEEP", fHslider2, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("V1 LFO FREQ", fHslider3, 1.0f, 0.0f, 80.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("V1 NOTE", fHslider1, 69.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("V1 VOLUME", fHslider0, 0.10000000000000001f, 0.0f, 0.90000000000000002f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALBARGRAPH("V2 LED LFO", fHbargraph1, -1.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("V2 LFO DEEP", fHslider6, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("V2 LFO FREQ", fHslider7, 1.0f, 0.0f, 80.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("V2 NOTE", fHslider5, 69.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("V2 VOLUME", fHslider4, 0.10000000000000001f, 0.0f, 0.90000000000000002f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALBARGRAPH("V3 LED LFO", fHbargraph2, -1.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("V3 LFO DEEP", fHslider10, 0.0f, 0.0f, 1.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("V3 LFO FREQ", fHslider11, 1.0f, 0.0f, 80.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("V3 NOTE", fHslider9, 69.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("V3 VOLUME", fHslider8, 0.10000000000000001f, 0.0f, 0.90000000000000002f, 0.10000000000000001f);
	FAUST_ADDBUTTON("trigger", fButton0);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, AMOUNT, "AMOUNT", fHslider12, 0.5f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, FEEDBACK, "FEEDBACK", fHslider13, 0.5f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, TIME, "TIME", fHslider14, 250.0f, 0.0f, 1000.0f, 1.0f) \
		p(HORIZONTALSLIDER, V1_LFO_DEEP, "V1 LFO DEEP", fHslider2, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, V1_LFO_FREQ, "V1 LFO FREQ", fHslider3, 1.0f, 0.0f, 80.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, V1_NOTE, "V1 NOTE", fHslider1, 69.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, V1_VOLUME, "V1 VOLUME", fHslider0, 0.10000000000000001f, 0.0f, 0.90000000000000002f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, V2_LFO_DEEP, "V2 LFO DEEP", fHslider6, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, V2_LFO_FREQ, "V2 LFO FREQ", fHslider7, 1.0f, 0.0f, 80.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, V2_NOTE, "V2 NOTE", fHslider5, 69.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, V2_VOLUME, "V2 VOLUME", fHslider4, 0.10000000000000001f, 0.0f, 0.90000000000000002f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, V3_LFO_DEEP, "V3 LFO DEEP", fHslider10, 0.0f, 0.0f, 1.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, V3_LFO_FREQ, "V3 LFO FREQ", fHslider11, 1.0f, 0.0f, 80.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, V3_NOTE, "V3 NOTE", fHslider9, 69.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, V3_VOLUME, "V3 VOLUME", fHslider8, 0.10000000000000001f, 0.0f, 0.90000000000000002f, 0.10000000000000001f) \
		p(BUTTON, trigger, "trigger", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \

	#define FAUST_LIST_PASSIVES(p) \
		p(HORIZONTALBARGRAPH, V1_LED_LFO, "V1 LED LFO", fHbargraph0, 0.0, -1.0f, 1.0f, 0.0) \
		p(HORIZONTALBARGRAPH, V2_LED_LFO, "V2 LED LFO", fHbargraph1, 0.0, -1.0f, 1.0f, 0.0) \
		p(HORIZONTALBARGRAPH, V3_LED_LFO, "V3 LED LFO", fHbargraph2, 0.0, -1.0f, 1.0f, 0.0) \

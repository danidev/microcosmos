...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		sig0->instanceInitmydspSIG0(sample_rate);
		sig0->fillmydspSIG0(48000, ftbl1);
		deletemydspSIG0(sig0);
	}
	
	virtual void instanceResetUserInterface() {
		fButton0 = FAUSTFLOAT(0.0f);
		fHslider0 = FAUSTFLOAT(64.0f);
		fHslider1 = FAUSTFLOAT(127.0f);
		fHslider2 = FAUSTFLOAT(127.0f);
		fButton1 = FAUSTFLOAT(0.0f);
		fButton2 = FAUSTFLOAT(0.0f);
		fHslider3 = FAUSTFLOAT(1.0f);
		fButton3 = FAUSTFLOAT(0.0f);
		fHslider4 = FAUSTFLOAT(64.0f);
		fHslider5 = FAUSTFLOAT(127.0f);
		fHslider6 = FAUSTFLOAT(127.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addButton("gate_1", &fButton1);
		ui_interface->addButton("gate_2", &fButton4);
		ui_interface->addHorizontalSlider("loop_length_1", &fHslider1, FAUSTFLOAT(127.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("loop_length_2", &fHslider5, FAUSTFLOAT(127.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalBargraph("loop_size_1", &fHbargraph1, FAUSTFLOAT(0.0f), FAUSTFLOAT(48000.0f));
		ui_interface->addHorizontalBargraph("loop_size_2", &fHbargraph4, FAUSTFLOAT(0.0f), FAUSTFLOAT(48000.0f));
		ui_interface->addHorizontalSlider("rate_1", &fHslider3, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("rate_2", &fHslider7, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalBargraph("read_index_1", &fHbargraph2, FAUSTFLOAT(0.0f), FAUSTFLOAT(48000.0f));
		ui_interface->addHorizontalBargraph("read_index_2", &fHbargraph5, FAUSTFLOAT(0.0f), FAUSTFLOAT(48000.0f));
		ui_interface->addHorizontalSlider("read_speed_1", &fHslider0, FAUSTFLOAT(64.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("read_speed_2", &fHslider4, FAUSTFLOAT(64.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addButton("rec_1", &fButton0);
		ui_interface->addButton("rec_2", &fButton3);
		ui_interface->addHorizontalBargraph("rec_index_1", &fHbargraph0, FAUSTFLOAT(0.0f), FAUSTFLOAT(48000.0f));
		ui_interface->addHorizontalBargraph("rec_index_2", &fHbargraph3, FAUSTFLOAT(0.0f), FAUSTFLOAT(48000.0f));
		ui_interface->addButton("stutter_1", &fButton2);
		ui_interface->addButton("stutter_2", &fButton5);
		ui_interface->addHorizontalSlider("volume_1", &fHslider2, FAUSTFLOAT(127.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("volume_2", &fHslider6, FAUSTFLOAT(127.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		int iSlow4 = (iSlow3 >= 1);
		int iSlow5 = iSlow3;
		int iSlow6 = int(fSlow0);
		float fSlow7 = (fConst1 * float(fHslider2));
		float fSlow8 = float(fButton1);
		float fSlow9 = float(fButton2);
		float fSlow10 = (fConst3 * float(fHslider3));
		float fSlow11 = float(fButton3);
		float fSlow12 = (fConst1 * float(fHslider4));
		float fSlow13 = (fConst1 * float(fHslider5));
		int iSlow14 = (fSlow11 == 0.0f);
		int iSlow15 = (iSlow14 >= 1);
		int iSlow16 = iSlow14;
		int iSlow17 = int(fSlow11);
		float fSlow18 = (fConst1 * float(fHslider6));
		float fSlow19 = float(fButton4);
		float fSlow20 = float(fButton5);
		float fSlow21 = (fConst3 * float(fHslider7));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			float fTemp0 = float(input0[i0]);
			fRec0[0] = std::fmod(((fSlow0 * fRec0[1]) + 1.0f), 48000.0f);
			fHbargraph0 = FAUSTFLOAT(int(fRec0[0]));
			ftbl0[int(fHbargraph0)] = fTemp0;
			fRec2[0] = (fSlow1 + (fConst2 * fRec2[1]));
			fRec3[0] = (fSlow2 + (fConst2 * fRec3[1]));
			fRec6[0] = (fSlow0 * (fRec6[1] + 1.0f));
			fRec5[0] = (iSlow6 ? fRec6[0] : fRec5[1]);
			fHbargraph1 = FAUSTFLOAT(int(fRec5[0]));
			int iTemp1 = int(fHbargraph1);
			iRec4[0] = (iSlow5 ? iTemp1 : iRec4[1]);
			float fTemp2 = std::max<float>((0.00787401572f * (fRec3[0] * float((iSlow4 ? iTemp1 : iRec4[0])))), 1.1920929e-07f);
			fRec1[0] = std::fmod((fRec1[1] + (0.0236220472f * fRec2[0])), ((fTemp2 < 48000.0f) ? fTemp2 : 48000.0f));
			fHbargraph2 = FAUSTFLOAT(int(fRec1[0]));
			fRec7[0] = (fSlow7 + (fConst2 * fRec7[1]));
			fVec0[0] = fSlow8;
			iRec8[0] = (iRec8[1] != ((fSlow8 - fVec0[1]) == 1.0f));
			fVec1[0] = fSlow9;
			iRec9[0] = (iRec9[1] != ((fSlow9 - fVec1[1]) == 1.0f));
			fRec10[0] = (fSlow10 + (fRec10[1] - std::floor((fSlow10 + fRec10[1]))));
			fRec11[0] = std::fmod(((fSlow11 * fRec11[1]) + 1.0f), 48000.0f);
			fHbargraph3 = FAUSTFLOAT(int(fRec11[0]));
			ftbl1[int(fHbargraph3)] = fTemp0;
			fRec13[0] = (fSlow12 + (fConst2 * fRec13[1]));
			fRec14[0] = (fSlow13 + (fConst2 * fRec14[1]));
			fRec17[0] = (fSlow11 * (fRec17[1] + 1.0f));
			fRec16[0] = (iSlow17 ? fRec17[0] : fRec16[1]);
			fHbargraph4 = FAUSTFLOAT(int(fRec16[0]));
			int iTemp3 = int(fHbargraph4);
			iRec15[0] = (iSlow16 ? iTemp3 : iRec15[1]);
			float fTemp4 = std::max<float>((0.00787401572f * (fRec14[0] * float((iSlow15 ? iTemp3 : iRec15[0])))), 1.1920929e-07f);
			fRec12[0] = std::fmod((fRec12[1] + (0.0236220472f * fRec13[0])), ((fTemp4 < 48000.0f) ? fTemp4 : 48000.0f));
			fHbargraph5 = FAUSTFLOAT(int(fRec12[0]));
			fRec18[0] = (fSlow18 + (fConst2 * fRec18[1]));
			fVec2[0] = fSlow19;
			iRec19[0] = (iRec19[1] != ((fSlow19 - fVec2[1]) == 1.0f));
			fVec3[0] = fSlow20;
			iRec20[0] = (iRec20[1] != ((fSlow20 - fVec3[1]) == 1.0f));
			fRec21[0] = (fSlow21 + (fRec21[1] - std::floor((fSlow21 + fRec21[1]))));
			float fTemp5 = (0.00787401572f * ((((ftbl0[int(fHbargraph2)] * fRec7[0]) * float(iRec8[0])) * ((iRec9[0] >= 1) ? float((fRec10[0] <= 0.5f)) : 1.0f)) + (((ftbl1[int(fHbargraph5)] * fRec18[0]) * float(iRec19[0])) * ((iRec20[0] >= 1) ? float((fRec21[0] <= 0.5f)) : 1.0f))));
	...
	#define FAUST_PASSIVES 6

	FAUST_ADDBUTTON("gate_1", fButton1);
	FAUST_ADDBUTTON("gate_2", fButton4);
	FAUST_ADDHORIZONTALSLIDER("loop_length_1", fHslider1, 127.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("loop_length_2", fHslider5, 127.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALBARGRAPH("loop_size_1", fHbargraph1, 0.0f, 48000.0f);
	FAUST_ADDHORIZONTALBARGRAPH("loop_size_2", fHbargraph4, 0.0f, 48000.0f);
	FAUST_ADDHORIZONTALSLIDER("rate_1", fHslider3, 1.0f, 1.0f, 20.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("rate_2", fHslider7, 1.0f, 1.0f, 20.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALBARGRAPH("read_index_1", fHbargraph2, 0.0f, 48000.0f);
	FAUST_ADDHORIZONTALBARGRAPH("read_index_2", fHbargraph5, 0.0f, 48000.0f);
	FAUST_ADDHORIZONTALSLIDER("read_speed_1", fHslider0, 64.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("read_speed_2", fHslider4, 64.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDBUTTON("rec_1", fButton0);
	FAUST_ADDBUTTON("rec_2", fButton3);
	FAUST_ADDHORIZONTALBARGRAPH("rec_index_1", fHbargraph0, 0.0f, 48000.0f);
	FAUST_ADDHORIZONTALBARGRAPH("rec_index_2", fHbargraph3, 0.0f, 48000.0f);
	FAUST_ADDBUTTON("stutter_1", fButton2);
	FAUST_ADDBUTTON("stutter_2", fButton5);
	FAUST_ADDHORIZONTALSLIDER("volume_1", fHslider2, 127.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("volume_2", fHslider6, 127.0f, 0.0f, 127.0f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(BUTTON, gate_1, "gate_1", fButton1, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, gate_2, "gate_2", fButton4, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, loop_length_1, "loop_length_1", fHslider1, 127.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, loop_length_2, "loop_length_2", fHslider5, 127.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, rate_1, "rate_1", fHslider3, 1.0f, 1.0f, 20.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, rate_2, "rate_2", fHslider7, 1.0f, 1.0f, 20.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, read_speed_1, "read_speed_1", fHslider0, 64.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, read_speed_2, "read_speed_2", fHslider4, 64.0f, 0.0f, 127.0f, 1.0f) \
		p(BUTTON, rec_1, "rec_1", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, rec_2, "rec_2", fButton3, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, stutter_1, "stutter_1", fButton2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, stutter_2, "stutter_2", fButton5, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, volume_1, "volume_1", fHslider2, 127.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, volume_2, "volume_2", fHslider6, 127.0f, 0.0f, 127.0f, 1.0f) \

	#define FAUST_LIST_PASSIVES(p) \
		p(HORIZONTALBARGRAPH, loop_size_1, "loop_size_1", fHbargraph1, 0.0, 0.0f, 48000.0f, 0.0) \
		p(HORIZONTALBARGRAPH, loop_size_2, "loop_size_2", fHbargraph4, 0.0, 0.0f, 48000.0f, 0.0) \
		p(HORIZONTALBARGRAPH, read_index_1, "read_index_1", fHbargraph2, 0.0, 0.0f, 48000.0f, 0.0) \
		p(HORIZONTALBARGRAPH, read_index_2, "read_index_2", fHbargraph5, 0.0, 0.0f, 48000.0f, 0.0) \
		p(HORIZONTALBARGRAPH, rec_index_1, "rec_index_1", fHbargraph0, 0.0, 0.0f, 48000.0f, 0.0) \
		p(HORIZONTALBARGRAPH, rec_index_2, "rec_index_2", fHbargraph3, 0.0, 0.0f, 48000.0f, 0.0) \

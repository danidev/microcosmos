...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("carrier1", &fHslider1, FAUSTFLOAT(440.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(523.25f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("carrier2", &fHslider2, FAUSTFLOAT(440.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(523.25f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("cutoff", &fHslider3, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(523.25f), FAUSTFLOAT(1.0f));
		ui_interface->addButton("gate", &fButton0);
		ui_interface->addHorizontalSlider("modulator", &fHslider0, FAUSTFLOAT(440.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(523.25f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp1 = (1.0f - std::fabs(((2.0f * fRec4[0]) + -1.0f)));
			float fTemp2 = (130.8125f * fTemp1);
			fVec2[0] = (fSlow1 + fTemp2);
			float fTemp3 = std::max<float>(fVec2[8], 23.4489498f);
			float fTemp4 = std::max<float>(20.0f, std::fabs(fTemp3));
			float fTemp5 = (fRec3[1] + (fConst3 * fTemp4));
			fRec3[0] = (fTemp5 - std::floor(fTemp5));
			float fTemp6 = mydsp_faustpower2_f(((2.0f * fRec3[0]) + -1.0f));
			fVec3[0] = fTemp6;
			float fTemp7 = ((fTemp0 * (fTemp6 - fVec3[1])) / fTemp4);
			fVec4[(IOTA & 4095)] = fTemp7;
			float fTemp8 = std::max<float>(0.0f, std::min<float>(2047.0f, (fConst5 / fTemp3)));
			int iTemp9 = int(fTemp8);
			float fTemp10 = std::floor(fTemp8);
			fRec2[0] = ((0.999000013f * fRec2[1]) + (fConst2 * ((fTemp7 - (fVec4[((IOTA - iTemp9) & 4095)] * (fTemp10 + (1.0f - fTemp8)))) - ((fTemp8 - fTemp10) * fVec4[((IOTA - (iTemp9 + 1)) & 4095)]))));
			float fTemp11 = ((fConst1 * (fRec2[0] * fVec2[8])) + 1.0f);
			fVec5[(IOTA & 31)] = (fSlow2 + fTemp2);
			float fTemp12 = fVec5[((IOTA - 16) & 31)];
			float fTemp13 = std::max<float>((fTemp11 * fTemp12), 23.4489498f);
			float fTemp14 = std::max<float>(20.0f, std::fabs(fTemp13));
			float fTemp15 = (fRec6[1] + (fConst3 * fTemp14));
			fRec6[0] = (fTemp15 - std::floor(fTemp15));
			float fTemp16 = mydsp_faustpower2_f(((2.0f * fRec6[0]) + -1.0f));
			fVec6[0] = fTemp16;
			float fTemp17 = ((fTemp0 * (fTemp16 - fVec6[1])) / fTemp14);
			fVec7[(IOTA & 4095)] = fTemp17;
			float fTemp18 = std::max<float>(0.0f, std::min<float>(2047.0f, (fConst5 / fTemp13)));
			int iTemp19 = int(fTemp18);
			float fTemp20 = std::floor(fTemp18);
			fRec5[0] = ((0.999000013f * fRec5[1]) + (fConst2 * ((fTemp17 - (fVec7[((IOTA - iTemp19) & 4095)] * (fTemp20 + (1.0f - fTemp18)))) - ((fTemp18 - fTemp20) * fVec7[((IOTA - (iTemp19 + 1)) & 4095)]))));
			fVec8[(IOTA & 31)] = (fSlow3 + fTemp2);
			float fTemp21 = fVec8[((IOTA - 24) & 31)];
			float fTemp22 = std::max<float>((fTemp11 * fTemp21), 23.4489498f);
			float fTemp23 = std::max<float>(20.0f, std::fabs(fTemp22));
			float fTemp24 = (fRec8[1] + (fConst3 * fTemp23));
			fRec8[0] = (fTemp24 - std::floor(fTemp24));
			float fTemp25 = mydsp_faustpower2_f(((2.0f * fRec8[0]) + -1.0f));
			fVec9[0] = fTemp25;
			float fTemp26 = ((fTemp0 * (fTemp25 - fVec9[1])) / fTemp23);
			fVec10[(IOTA & 4095)] = fTemp26;
			float fTemp27 = std::max<float>(0.0f, std::min<float>(2047.0f, (fConst5 / fTemp22)));
			int iTemp28 = int(fTemp27);
			float fTemp29 = std::floor(fTemp27);
			fRec7[0] = ((0.999000013f * fRec7[1]) + (fConst2 * ((fTemp26 - (fVec10[((IOTA - iTemp28) & 4095)] * (fTemp29 + (1.0f - fTemp27)))) - ((fTemp27 - fTemp29) * fVec10[((IOTA - (iTemp28 + 1)) & 4095)]))));
			float fTemp30 = std::tan((fConst6 * ((fSlow4 * (fTemp1 + 1.0f)) + 1.0f)));
			float fTemp31 = (1.0f / fTemp30);
			float fTemp32 = (((fTemp31 + 1.25f) / fTemp30) + 1.0f);
			fRec1[0] = ((fConst1 * (fTemp11 * ((fRec5[0] * fTemp12) + (fRec7[0] * fTemp21)))) - (((fRec1[2] * (((fTemp31 + -1.25f) / fTemp30) + 1.0f)) + (2.0f * (fRec1[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp30)))))) / fTemp32));
			float fTemp33 = (fTemp30 * fTemp32);
			float fTemp34 = (float(iRec0[0]) * ((0.800000012f * (fRec1[0] / fTemp33)) + (fRec1[2] * (0.0f - (0.800000012f / fTemp33)))));
	...
	FAUST_ADDHORIZONTALSLIDER("carrier1", fHslider1, 440.0f, 0.0f, 523.25f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("carrier2", fHslider2, 440.0f, 0.0f, 523.25f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("cutoff", fHslider3, 0.0f, 0.0f, 523.25f, 1.0f);
	FAUST_ADDBUTTON("gate", fButton0);
	FAUST_ADDHORIZONTALSLIDER("modulator", fHslider0, 440.0f, 0.0f, 523.25f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, carrier1, "carrier1", fHslider1, 440.0f, 0.0f, 523.25f, 1.0f) \
		p(HORIZONTALSLIDER, carrier2, "carrier2", fHslider2, 440.0f, 0.0f, 523.25f, 1.0f) \
		p(HORIZONTALSLIDER, cutoff, "cutoff", fHslider3, 0.0f, 0.0f, 523.25f, 1.0f) \
		p(BUTTON, gate, "gate", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, modulator, "modulator", fHslider0, 440.0f, 0.0f, 523.25f, 1.0f) \
